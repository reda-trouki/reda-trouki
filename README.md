...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=java,c,cpp,graphql,css,html,js,php,nodejs,python,ts,angular,bootstrap,chakraui,chartjs,electron,postman,prisma,redux,svg,express,vue,jquery,flask,jwt,react,laravel,tailwind,spring,mongodb,mysql,postgres&theme=light" />
  </a>
</p>
